                ...
                if amort == 0:
                    ...
                    if chat_id in QUEUE:
                        ...
                        try:
                            ...
                            await suhu.delete()
                            await m.reply_text(f"خِطَأ قام احد مشرفي المجموعه بحظر الحساب المساعد برجاء رفع الحظر عنه لكي اعمل @{ASSISTANT_NAME} : `{ep}`")
